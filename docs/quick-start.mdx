...
1. The ClickHouse server listens for HTTP clients on port 8123 by default. There is a built-in UI for running SQL queries at <a href="http://127.0.0.1:8123/play" target="_blank">http://127.0.0.1:8123/play</a> (change the hostname accordingly). 
    ...
    <img src={require('../static/images/quickstart_01.png').default} class="image" alt="The Play UI" />
...
3. Click the **RUN** button and the response is displayed in the lower portion of the Play UI:
    ...
    <img src={require('../static/images/quickstart_02.png').default} class="image" alt="View the results" />
...
2. Let's verify it worked:
    ...
    <img src={require('../static/images/quickstart_03.png').default} class="image" alt="New rows inserted" />
...
3. Notice the new rows appear in the table now:
    <img src={require('../static/images/quickstart_04.png').default} class="image" alt="New rows from CSV file" />
...
- If your data is coming from an external source, view our <a href="https://clickhouse.com/integrations/">collection of integration guides</a> for connecting to message queues, databases, pipelines and more
- If you are using a UI/BI visualization tool, view the <a href="https://clickhouse.com/connect-a-ui/">user guides for connecting a UI to ClickHouse</a>
